...
from api.controllers.removed_characters import *


class RemovedCharacters(Resource):
    @swag_from('../templates/index.yml', endpoint='/game/{game_uuid}/removed_characters')
    def get(self, game_uuid):
        ...
        return get_removed_characters(str(game_uuid), args['sort_order'], args['order_by'], args['limit'], args['offset'])


api.add_resource(RemovedCharacters, '/game/<string:game_uuid>/removed_characters')
