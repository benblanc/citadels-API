...
from api.controllers.possible_characters import *


class PossibleCharacters(Resource):
    @swag_from('../templates/index.yml', endpoint='/game/{game_uuid}/possible_characters')
    def get(self, game_uuid):
        ...
        return get_possible_characters(str(game_uuid), args['sort_order'], args['order_by'], args['limit'], args['offset'])


api.add_resource(PossibleCharacters, '/game/<string:game_uuid>/possible_characters')
