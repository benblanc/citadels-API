...
def get_drawn_cards(game_uuid, player_uuid, sort_order, order_by, limit, offset):
    try:
        ...
        cards = transactions.get_all_from_query(drawn_cards_db, sort_order, order_by, limit, offset, uuid=player_uuid, player_table=True)  # get all from database based on query
